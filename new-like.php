...
function getDraftlink( $post_id ) {
	...
	if ( AlreadyLiked( $post_id ) ) {
		...
		$output = '<a href="#" class="jm-home-like'.esc_attr( $class ).' " data-post_id="'.esc_attr( $post_id ).'" title="'.esc_attr( $title ).'">'.$heart.'<span class="jm-load"></span></a>';
	return $output;
